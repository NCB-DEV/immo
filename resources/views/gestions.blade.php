                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 mt-10" style="margin-bottom: 20px">
                            <div class="parcele">
                                ...
                                <div class="info">
                                    ...
                                    <a href="{{ route('supprimer-parcelle',['id'=>$pars->id]) }}" class="btn btn-danger">supprimer</a>
                                    <a href="{{ route('modifier-parcelle',['id'=>$pars->id,'proprietaire'=>$proprietaire->id]) }}" class="btn btn-warning">modifier</a>
