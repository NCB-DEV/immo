...
<div class="containter modifs">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <h3>Modification de la parcelle numero {{ $parcel->id }}</h3>
        </div>
        <div class="col-sm-12 col-md-3 col-lg-3"></div>
    </div>
</div>
            ...
            <div class="inforenregistrer">
                ...
                <table class="table table-striped">
                    ...
                    <tr >
                        ...
                        <td>
                            2<img style="object-fit: cover; height:100px" class="w-100" src="{{ asset('storage/'.$parcel->photo2 ) }}" >
                        </td>
                        <td>
                            3<img style="object-fit: cover; height:100px" class="w-100" src="{{ asset('storage/'.$parcel->photo2 ) }}" >
                        </td>
                        <td>
                            4<img style="object-fit: cover; height:100px" class="w-100" src="{{ asset('storage/'.$parcel->photo2 ) }}" >
                        </td>
                        <td>
                           5 <img style="object-fit: cover; height:100px" class="w-100" src="{{ asset('storage/'.$parcel->photo2 ) }}" >
                        </td>
                    </tr>
                </table>
